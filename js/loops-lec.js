...
//
// while ( i <= 100) {
//     console.log("Counting by 10s up to 100: " + i);
//     i = i + 10;
//
// }
...
//
// while ( i > 0 ) {
//     console.log("Counting by 1s up to 50: " + i);
//     i = i - 1;
// }
...
// do {
//     var colorBlue = prompt("What is your color?").toLowerCase();
//     console.log("You color is, " + colorBlue);
// } while ( colorBlue !== "blue" );
...
//     console.log("Numbers divisible by 5, from 0 - 100 using a for loop " + i);
// }
...
for ( var i = 1; i <= 100; i++) {
    if ((i % 3 == 0) && (i % 5 !== 0)) {
        console.log("Fizz, divisible by 3: " + i);
    } else if ((i % 5 == 0) && (i % 3 !== 0)) {
        console.log("Bizz, divisible by 5: " + i);
    } else if ((i % 3 == 0) && (i % 5 == 0)) {
        console.log("FizzBuzz, divisible by 3 and 5: " + i);
    } else {
